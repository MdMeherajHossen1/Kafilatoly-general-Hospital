    ...
    return (
        <>
            <div className=" bg-gray-900 grid grid-cols-1 md:grid-cols-3 gap-4 py-8 px-12 text-white">
                <div className="col">
                    <h3 className="bg-green-500 rounded-md p-1  hover:bg-gray-900">KAFILATOLY GENERAL HOSPITAL</h3>
                ...
                <div className="col">
                    <h3 className="bg-green-500 p-2 rounded-lg hover:bg-gray-900"><i className="fab fa-servicestack"></i> OUR SERVICES</h3>
                ...
                <div className="col text-left">
                    <h3 className="bg-green-500 text-center p-2 rounded-lg hover:bg-gray-900"><i className="far fa-address-card"></i> CONTACT US</h3>
                    ...
                    <div>
                        <h6 className="bg-green-500 text-center p-1 rounded-lg hover:bg-gray-900">MORE CONTACT</h6>
